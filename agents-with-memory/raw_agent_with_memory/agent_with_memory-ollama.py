...
class AgentMemory2:
    ...
    def __init__(self, storage_dir: str = "./agent_memory2"):
...
class OpenAIAgent2:
    """AI agent using OpenAI's llama3.1:8b with memory capabilities."""

    def __init__(self, api_key: str = None, memory_dir: str = "./agent_memory2"):
        ...
        self.memory = AgentMemory2(memory_dir)
        self.model = "llama3.1:8b"  # You can change this to "gpt-4o" for the full model
...
def main():
    ...
    agent.learn_procedure(
        ...
        [
            ...
            "Connect memory system to an LLM like llama3.1:8b",
