...
# Explicitly set a custom User-Agent to satisfy Wikipedia's API policy
# api_wrapper = WikipediaAPIWrapper()
# api_wrapper.wiki_client.API_URL = "https://wikipedia.org"
# import wikipedia
# wikipedia.set_user_agent("RomanEmpireGraphRAG/1.0 (rohitdhingra@example.com)")

# # Pass the configured wrapper or call the loader safely
# raw_documents = WikipediaLoader(query="The Roman empire", load_max_docs=3).load()
